/**
 * Genera el vector de búsqueda (embedding) vía OpenAI.
 * Dimensión 1536 = text-embedding-3-small, alineada a migración 008.
 *
 * Precauciones:
 * - Requiere AI_BUSQUEDA_ENABLE=true (no corre “por accidente”).
 * - Requiere OPENAI_API_KEY.
 * - Sin SDK extra: un fetch acotado, reintentos suaves ante 429/5xx.
 */
...
export { MODELO_EMBEDDING, DIMENSION };
